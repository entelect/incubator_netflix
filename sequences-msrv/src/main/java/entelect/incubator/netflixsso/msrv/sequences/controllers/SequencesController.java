...
public class SequencesController {
    ...
    @GetMapping("sequence/{type}/{depth}")
    public String generateSequence(@PathVariable("type") String type, @PathVariable("depth") int depth) {
        return "\""+sequencesService.generateSequence(type, depth)+"\"";
    }
